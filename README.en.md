...
**CAUTION: This script has limitations on processing results according to their URLs when you are not logged in to Google. Refer to [Limitations](Limitations#完全urlの隠蔽-2026年夏仕様変更) for more information.**
