...
**注意: Googleにログインしていない状態では、URLに基づく処理に制限があります。詳しくは[機能制限](https://github.com/djtkdk-086969/google-search-cleaner/wiki/Limitations#完全urlの隠蔽-2026年夏仕様変更)をご参照ください。**
